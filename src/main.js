...
const navbarMenuItemActive = document.querySelector(
  '.navbar__menu__item.active'
);
navbarMenu.addEventListener('click', (e) => {
  navbarMenuItemActive.classList.remove('active');
...
workBtnContainer.addEventListener('click', (e) => {
  ...
  // Remove selection from the previous item an select the new one
